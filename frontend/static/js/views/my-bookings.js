          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div v-else class="text-center py-4">
                ...
                <p class="text-muted mb-3">Get a personalised day-by-day itinerary, packing list, and safety tips for your trek — generated by AI.</p>
                <button class="btn btn-ridge" @click="generatePlan">
                  <i class="bi bi-stars me-2"></i>Generate itinerary
                </button>
              </div>
            </div>
          </div>
